...
<form action="<?php echo JRoute::_('index.php'); ?>" class="form-validate" method="post" name="emailForm" id="emailForm">
	<div class="contact_email<?php echo $this->escape($this->params->get( 'pageclass_sfx' )); ?>">
		...
		<input type="text" name="name" id="contact_name" size="30" style="width:175px; height:20px; font-size:11px; font-weight:normal; text-align:left; border:1px solid #b0b0b0;" value="" />
	</div>
	<div class="contact_email<?php echo  $this->escape($this->params->get( 'pageclass_sfx' )); ?>"><label id="contact_emailmsg" for="contact_email">
		...
		<input type="text" id="contact_email" name="email" size="30" value="" style="width:175px; height:20px; font-size:11px; font-weight:normal; text-align:left; border:1px solid #b0b0b0;" class="inputbox required validate-email" maxlength="100" />
	</div>
	<div class="contact_email<?php echo  $this->escape($this->params->get( 'pageclass_sfx' )); ?>"><label for="contact_subject">
		...
		<input type="text" name="subject" id="contact_subject" size="30" style="width:175px; height:20px; font-size:11px; font-weight:normal; text-align:left; border:1px solid #b0b0b0;" value="" />
	</div>
