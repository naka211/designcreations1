...
<div class="buttonheading" style="float:right">
...
<?php if ($this->item->params->get('show_title')) : ?>
	...
	<?php if ($this->item->params->get('link_titles') && $this->item->readmore_link != '') : ?>
		<h2> <a href="<?php echo $this->item->readmore_link; ?>" class="contentpagetitle<?php echo $this->item->params->get('pageclass_sfx'); ?>" title="">
			<?php echo $this->escape($this->item->title); ?></a></h2>
	<?php else :
		echo "<h2>".$this->escape($this->item->title) ."</h2>";
	endif; ?>
...
<div class="box-text"><?php echo JFilterOutput::ampReplace($this->item->text);  ?></div>
<div class="cb"></div>
<?php if ($this->item->params->get('show_readmore') && $this->item->readmore) : ?>
<div class="more" style="float:right; padding-right:15px" >
	<a href="<?php echo $this->item->readmore_link; ?>" class="readon<?php echo $this->item->params->get('pageclass_sfx'); ?>">Xem chi tiết</a>
</div>
<?php endif; ?>
